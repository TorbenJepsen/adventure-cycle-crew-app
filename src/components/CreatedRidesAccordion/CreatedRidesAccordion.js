        ...
        <ExpansionPanel expanded={expanded === 'panel1'} onChange={this.handleChange('panel1')}>
          ...
          <ExpansionPanelDetails>
            <Typography>
                ...
                <br />
                <div>
                <Button variant="raised" size="small" color="primary" onClick={() => this.props.handleClickEdit(this.props.ride)}>
                Edit Ride
            </Button>
            </div>
            <div>
            <Button variant="raised" size="small" color="secondary" onClick={() => this.props.cancelRide(this.props.ride)}>
                Remove Ride?
            </Button>
            </div>
            </Typography>
